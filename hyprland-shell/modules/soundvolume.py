...
from ctl import CtlSoundVolume
from data import DataConfig
from lang import Lang

class SoundVolumeWidget:
    def lang_init(self):
        self.text = Lang()
        self.text.set_text('ru','title','Звук')
        self.text.set_text('en','title','Sound')
    ...
    def __init__(self, **kwargs):
        ...
        self.iconNameMute = 'hs-volume-muted'
        self.iconNameUnMute = 'hs-volume'

        _params = DataConfig.getConfigDockModulParams(modul='SoundVolume')
    ...
    def refreshInfo(self, is_button:bool, is_window:bool):
        CtlSoundVolume.exec_get()
        self.is_mute = CtlSoundVolume.is_mute()
        self.value = CtlSoundVolume.get_value()
